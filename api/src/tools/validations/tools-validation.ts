...
export const ProtocolNameEnum = z
  .enum(['lifi', 'curve', 'transfer','symbiosis', 'stryke'])
...
export const ChainIdSchema = z.object({
  networkId: z.string().describe(`The network id. Available networks:   "eth", "bsc", "polygon_pos", "avax", "movr", "cro", "one", "boba", "ftm", "bch","aurora", "metis", "arbitrum", "fuse", "kcc", "iotx", "celo", "xdai", "glmr","optimism", "nrg", "wan", "ronin", "kai", "mtr", "velas", "sdn", "tlos","oasis", "astr", "ela", "milkada", "dfk", "evmos", "solana", "cfx", "bttc","sxn", "xdc", "kaia", "kava", "bitgert", "tombchain", "dogechain", "findora","thundercore", "arbitrum_nova", "canto", "ethereum_classic", "step-network","ethw", "godwoken", "songbird", "tomochain", "fx", "platon_network","exosama", "oasys", "bitkub_chain", "wemix", "flare", "onus", "aptos", "core","filecoin", "zksync", "loopnetwork", "multivac", "polygon-zkevm", "eos-evm","ultron", "sui-network", "pulsechain"`)
});
